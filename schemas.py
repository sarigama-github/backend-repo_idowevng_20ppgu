...
# Architecture company specific schema
...
class Inquiry(BaseModel):
    ...
    service: str = Field(..., description="Requested service: architecture | energy_certificate | blower_door")
    message: Optional[str] = Field(None, max_length=2000, description="Message details")
